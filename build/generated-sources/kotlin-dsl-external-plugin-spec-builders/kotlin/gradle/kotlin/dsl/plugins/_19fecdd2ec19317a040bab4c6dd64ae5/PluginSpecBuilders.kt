...
package gradle.kotlin.dsl.plugins._19fecdd2ec19317a040bab4c6dd64ae5
...
/**
 * The `at.zierler` plugin group.
 */
@org.gradle.api.Generated
internal
class `AtZierlerPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `at.zierler`.
 */
internal
val `AtPluginGroup`.`zierler`: `AtZierlerPluginGroup`
    get() = `AtZierlerPluginGroup`(plugins)


/**
 * The `at.zierler.yamlvalidator` plugin implemented by [at.zierler.gradle.YamlValidatorPlugin].
 */
internal
val `AtZierlerPluginGroup`.`yamlvalidator`: PluginDependencySpec
    get() = plugins.id("at.zierler.yamlvalidator")
